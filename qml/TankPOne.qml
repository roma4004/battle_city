...
Rectangle{ //player1
    ...
    property int spawnPosMaxX: mainWindow.width /2 - battlefield.blockWidth * 6
    ...
    Timer{
        ...
        onTriggered:{
            if(!battlefield.isTimerBonusActPl){
              ...
              //if(parent.isPressedUp    && !battlefield.isTimerBonusActPl) {JS.moveObj(parent, "U")}else
              //if(parent.isPressedRight && !battlefield.isTimerBonusActPl) {JS.moveObj(parent, "R")}else
              //if(parent.isPressedDown  && !battlefield.isTimerBonusActPl) {JS.moveObj(parent, "D")}else
              //if(parent.isPressedLeft  && !battlefield.isTimerBonusActPl) {JS.moveObj(parent, "L")}
            }
